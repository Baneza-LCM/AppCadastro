...
fun readDataFromDatabase(context: Context) {
    ...
    courseList = dbHandler.readDatas()!!
        ...
        itemsIndexed(courseList) { index, item ->
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = "Data Tracks: " + courseList[index].Tende,
                        modifier = Modifier.padding(4.dp),
                        color = Color.Black, textAlign = TextAlign.Center
                    )
                    ...
                    Text(
                        text = "Data Duration: " + courseList[index].Tbairro,
                        modifier = Modifier.padding(4.dp),
                        color = Color.Black, textAlign = TextAlign.Center
                    )
                    ...
                    Text(
                        text = "Descrição: " + courseList[index].Tcep,
                        modifier = Modifier.padding(4.dp),
                        color = Color.Black, textAlign = TextAlign.Center
                    )
                    ...
                    Text(
                        text = "Data Duration: " + courseList[index].Tcidad,
                        modifier = Modifier.padding(4.dp),
                        color = Color.Black, textAlign = TextAlign.Center
                    )
                    ...
                    Text(
                        text = "Data Duration: " + courseList[index].Testad,
                        modifier = Modifier.padding(4.dp),
                        color = Color.Black, textAlign = TextAlign.Center
                    )
                    ...
                    Text(
                        text = "Data Duration: " + courseList[index].Ttel,
                        modifier = Modifier.padding(4.dp),
                        color = Color.Black, textAlign = TextAlign.Center
                    )
                    ...
                    Text(
                        text = "Data Duration: " +courseList[index].Tcell,
                        modifier = Modifier.padding(4.dp),
                        color = Color.Black, textAlign = TextAlign.Center
                    )
                }
